...
public class EventRCVAdapter extends RecyclerView.Adapter<EventRCVAdapter.ViewHolder> {
    private Context context;
    private ArrayList<ActivityDetails> listOfEvent;
    private AppListeners.OnItemClickListener onItemClickListener;
    private String TAG = EventRCVAdapter.class.getSimpleName();
    @SuppressLint("UseSparseArrays")
    private HashMap<Long, Integer> positionHeader = new HashMap<>();

    public EventRCVAdapter(Context context, ArrayList<ActivityDetails> listOfEvent) {
  ...
  /*  public void remove(int position) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        private final TextView titleTV, locationTV, timeTV, dateTV/*, yearTV*/;
        private final RelativeLayout list_row_RL, header;

        ViewHolder(View view) {
            super(view);
            header = view.findViewById(R.id.rl_agenda_header);
            list_row_RL = view.findViewById(R.id.event_RL);
...
//            yearTV = view.findViewById(R.id.tv_date_year);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.event_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.timeTV.setText(activityDetailsDao.getStartTime());
        holder.timeTV.setTypeface(Util.setTextViewTypeFace(context, "DroidSans-Bold.ttf"));
