...
public class HttpPostDataNew extends SafeAsyncTask<String> {
    ...
    //String accessToken;
    public HttpPostDataNew(String message, String url, String body, BaseActivity baseActivity) {
...
//        _dialog.setMessage(message);
    ...
    public HttpPostDataNew(String message, String url, String body, BaseFragment baseFragment) {
