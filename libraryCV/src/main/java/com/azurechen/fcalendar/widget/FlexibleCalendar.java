    ...
    protected void redraw() {
        ...
        if (rowWeek != null) {
            for (int i = 0; i < rowWeek.getChildCount(); i++) {
                ((TextView) rowWeek.getChildAt(i)).setBackgroundColor(getResources().getColor(R.color.white)/*getTextColor()*/);
            }
        }
        ...
        if (mAdapter != null) {
            for (int i = 0; i < mAdapter.getCount(); i++) {
                ...
                txtDay.setBackgroundDrawable(getResources().getDrawable(R.drawable.unselected));
                Typeface font = Typeface.createFromAsset(mContext.getAssets(), "DroidSans.ttf");
                txtDay.setTypeface(font);
                txtDay.setTextColor(mContext.getResources().getColor(R.color.month_date_color));
                // set today's item
                if (isToady(day)) {
    ...
    protected void reload() {
        if (mAdapter != null) {
            ...
            for (int i = 0; i < 7; i++) {
                ...
                txtDayOfWeek.setTextColor(getResources().getColor(R.color.week_days_color));
                Typeface font = Typeface.createFromAsset(mContext.getAssets(), "DroidSans.ttf");
                txtDayOfWeek.setTypeface(font);
                txtDayOfWeek.setTextSize(13);
                view.setLayoutParams(new TableRow.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1));
