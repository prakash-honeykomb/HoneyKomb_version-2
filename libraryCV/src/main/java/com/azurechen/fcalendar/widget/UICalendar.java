...
public abstract class UICalendar extends LinearLayout {
    ...
    public LockScrollView mScrollViewBody;
    protected TableLayout mTableBody;
    protected RelativeLayout mLayoutBtnGroupMonth;
    public RelativeLayout mLayoutBtnGroupWeek;
...
//        setTodayItemTextColor(attrs.getColor(R.styleable.UICalendar_todayItem_textColor, mTodayItemTextColor));
        setTodayItemTextColor(mContext.getResources().getColor(R.color.white));
    ...
    public void setStyle(int style) {
        ...
        if (style == STYLE_LIGHT) {
            ...
            setTodayItemBackgroundDrawable(getResources().getDrawable(R.drawable.circle_black_stroke_background));
            setSelectedItemBackgroundDrawable(getResources().getDrawable(R.drawable.circle_black_solid_background));
            ...
            setButtonLeftDrawable(getResources().getDrawable(R.drawable.ic_navigate_before_white));
            setButtonRightDrawable(getResources().getDrawable(R.drawable.ic_navigate_next_white));
...
//        mTxtTitle.setTextColor(mTextColor);
        Typeface font = Typeface.createFromAsset(mContext.getAssets(), "DroidSans-Bold.ttf");
